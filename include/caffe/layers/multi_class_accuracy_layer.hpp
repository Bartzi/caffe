#ifndef MULTI_CLASS_ACCURACY_LAYER_HPP
#define MULTI_CLASS_ACCURACY_LAYER_HPP
...
/**
 * @brief Computes the classification accuracy for several one-of-many
...
class MultiClassAccuracyLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  int num_classes_, num_classifiers_;
